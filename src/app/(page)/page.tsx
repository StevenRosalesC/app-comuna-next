        ...
        <div className="flex flex-col lg:flex-row items-center w-full h-full">
          <div className="basis-1/2 flex flex-col justify-between">
            <div className="p-4">
              ...
              <a href="mailto:comuna@gmail.com">
                comuna@gmail.com
              </a>
            </div>
            <div className="p-4">
              ...
              <p>Llamanos para más información:
              </p>
            ...
            <div className="p-4">
              ...
              <p>Santa Elena, Parroquia Colonche, Bambil Collao - Barrio 3 de Noviembre - Frente a la cancha de uso múltiple, Ecuador.
              </p>
            </div>
