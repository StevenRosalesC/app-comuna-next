    ...
    <div>
      <div className='mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8'>
        <div className='grid gap-y-8 lg:grid-cols-3 lg:gap-x-6 lg:gap-y-0'>
          <div className='lg:col-span-2'>
            <div className='py-8 lg:pe-8'>
              <div className='space-y-5 lg:space-y-8'>
                <Link
                  className='inline-flex items-center gap-x-1.5 text-sm text-gray-600 decoration-2 hover:underline focus:underline focus:outline-none dark:text-blue-500'
                  href='/notices'
                >
                  <svg
                ...
                <h2 className='text-3xl font-bold dark:text-white lg:text-5xl'>
                  Announcing a free plan for small teams
                </h2>

                <div className='flex items-center gap-x-5'>
                  <a
                    className='inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1 text-xs text-gray-800 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 sm:px-4 sm:py-2 sm:text-sm'
                    href='#'
                  >
                    Company News
                  </a>
                  <p className='text-xs text-gray-800 dark:text-neutral-200 sm:text-sm'>
                    January 18, 2023
                  </p>
                </div>
                ...
                <div className='text-center'>
                  <div className='grid gap-3 lg:grid-cols-2'>
                    <div className='grid grid-cols-2 gap-3 lg:grid-cols-1'>
                      <figure className='relative z-0 h-60 w-full'>
                        <Image
                          width={1920}
                          height={1080}
                    ...
                    <figure className='relative z-0 h-72 w-full sm:h-96 lg:h-full'>
                      <Image
                        width={1920}
                        height={1080}
                        className='absolute start-0 top-0 size-full rounded-xl object-cover'
                  ...
                  <span className='mt-3 block text-center text-sm text-gray-500 dark:text-neutral-500'>
                    Working process
                  </span>
                </div>
                ...
                <blockquote className='p-4 text-center sm:px-7'>
                  <p className='text-xl font-medium text-gray-800 dark:text-neutral-200 lg:text-2xl lg:leading-normal xl:text-2xl xl:leading-normal'>
                ...
                <ul className='list-outside list-disc space-y-5 ps-5 text-lg text-gray-800 dark:text-neutral-200'>
                  <li className='ps-2'>
                ...
                <div className='flex flex-col gap-y-5 lg:flex-row lg:items-center lg:justify-between lg:gap-y-0'>
                  <div>
                    <a
                      className='m-0.5 inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-2 text-sm text-gray-800 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700'
                      href='#'
                    >
                      Plan
                    </a>
                  ...
                  <div className='flex items-center justify-end gap-x-1.5'>
                    <div className='hs-tooltip inline-block'>
                      <button
                        type='button'
                        className='hs-tooltip-toggle flex items-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:text-gray-800 focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200'
                      >
                        <svg
                          className='size-4 shrink-0'
                          xmlns='http://www.w3.org/2000/svg'
                    ...
                    <div className='mx-3 block h-3 border-e border-gray-300 dark:border-neutral-600'></div>
                    ...
                    <div className='hs-dropdown relative z-0 inline-flex'>
                      <button
                        ...
                        type='button'
                        className='hs-dropdown-toggle flex items-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:text-gray-800 focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200'
                        aria-haspopup='menu'
                        aria-expanded='false'
                        aria-label='Dropdown'
                      >
                      ...
                      >
                        <a
                          className='flex items-center gap-x-3.5 rounded-lg px-3 py-2 text-sm text-gray-400 hover:bg-white/10 focus:bg-white/10 focus:outline-none dark:text-neutral-400 dark:hover:bg-neutral-900 dark:focus:bg-neutral-900'
                          href='#'
                        >
                          <svg
                            className='size-4 shrink-0'
                        ...
                        <div className='my-2 border-t border-gray-600 dark:border-neutral-800'></div>
                        <a
                          className='flex items-center gap-x-3.5 rounded-lg px-3 py-2 text-sm text-gray-400 hover:bg-white/10 focus:bg-white/10 focus:outline-none dark:text-neutral-400 dark:hover:bg-neutral-900 dark:focus:bg-neutral-900'
                          href='#'
                        >
          ...
          <div className='dark:from-neutral-800 lg:col-span-1 lg:h-full lg:w-full lg:bg-gradient-to-r lg:from-gray-50 lg:via-transparent lg:to-transparent'>
            <div className='sticky start-0 top-0 py-8 lg:ps-8'>
              <div className='group mb-8 flex items-center gap-x-3 border-b border-gray-200 pb-8 dark:border-neutral-700'>
                ...
                <a className='group block grow focus:outline-none' href=''>
                  <h5 className='text-sm font-semibold text-gray-800 group-hover:text-gray-600 group-focus:text-gray-600 dark:text-neutral-200 dark:group-hover:text-neutral-400 dark:group-focus:text-neutral-400'>
                    Leyla Ludic
                  </h5>
                ...
                <div className='grow'>
                  <div className='flex justify-end'>
                    <button
                      type='button'
                      className='inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-2.5 py-1.5 text-xs font-medium text-white hover:bg-blue-700 focus:bg-blue-700 focus:outline-none disabled:pointer-events-none disabled:opacity-50'
                    >
                      <svg
                        className='size-4 shrink-0'
                        xmlns='http://www.w3.org/2000/svg'
              ...
              <div className='space-y-6'>
                ...
                >
                  ...
                  <div className='relative z-0 size-20 shrink-0 overflow-hidden rounded-lg'>
                    <Image
                      width={100}
                      height={100}
